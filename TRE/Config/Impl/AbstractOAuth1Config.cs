...
{
    public abstract class AbstractOAuth1Config : AbstractCommonConfig, IOAuth1Config
    {
        protected String appSecret;

        public virtual String getAppSecret()
        {
            return appSecret;
        }
        ...
        {
            return AuthConfigHelper.AUTH_TYPE_OAUTH1;
        }
